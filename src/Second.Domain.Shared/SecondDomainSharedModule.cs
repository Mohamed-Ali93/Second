...
public class SecondDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SecondGlobalFeatureConfigurator.Configure();
        SecondModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SecondDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SecondResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Second");

            options.DefaultResourceType = typeof(SecondResource);
        ...
        {
            options.MapCodeNamespace("Second", typeof(SecondResource));
        });
    }
}
